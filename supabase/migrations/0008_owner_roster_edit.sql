...
-- show the new owners.
--
-- Numbered 0008 simply to sort last; it is independent of 0006 (champion) and
-- 0007 (season). This one touches only picks/players, so it can be applied
-- whether or not those have been.
--
